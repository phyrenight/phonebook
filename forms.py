...
class ContactForm(FlaskForm):
    first_name = StringField(
        'First name',
        validators=[
            DataRequired('Please enter a first name for this contact')])
    last_name = StringField(
        'Last name',
        validators=[
            DataRequired('Please enter a last name for this contact')])
    phone_number = StringField(
        'Phone number',
        validators=[
            DataRequired('Please enter a phone number'),
            Length(min=6, message='Please enter a valid phone number')])
